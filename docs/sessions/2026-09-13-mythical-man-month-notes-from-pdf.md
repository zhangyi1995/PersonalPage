...
| 02 | 人月神话 | 12 | 干将莫邪 |
| 03 | 外科手术队伍 | 13 | 整体部分 |
| 04 | 贵族专制、民主政治和系统设计 | 14 | 祸起萧墙 |
| 05 | 画蛇添足 | 15 | 另外一面 |
| 06 | 贯彻执行 | 16 | 没有银弹 |
| 07 | 为什么巴比伦塔会失败 | 17 | 再论"没有银弹" |
| 08 | 胸有成竹 | 18 | 观点：是与非 |
| 09 | 削足适履 | 19 | 20 年后的《人月神话》 |
| 10 | 提纲挈领 | 20 | 结束语 |

- 每篇含四节：这一章讲了什么 / 我的判断 / 和我手上的工作有什么关系 / 一句话记住。
- `series_weight` 从 10 递增到 200，与文件名编号对齐（01↔10 … 20↔200）。
- 第 20 篇按第 18 章的方法附上了完整系列的论断清单（分"我确认"与"我存疑"两张表）。
- 系列页 20 个成员顺序正确，第 19 篇横幅显示"第 19 / 共 20 篇"，严格构建零警告。

### 遗留与约定

- 全书正文只存 `/tmp/mmm_txt/`，未入库；`bin/ocr-pdf.py` 保留供后续扫描版书籍复用。
- 本系列为中文单语，英文首页有意不设入口（见 `AGENTS.md`）。
- 各章中文章名以本书目录为准；第 1、2 章之外的译名均由 OCR 结果核对。
